    ...
    <div style={{ display: "flex", minHeight: "100vh" }}>
      ...
      <aside className="glass-panel" style={{ width: "260px", margin: "1rem", display: "flex", flexDirection: "column" }}>
        <div style={{ marginBottom: "2rem" }}>
          ...
          <span className="badge badge-danger" style={{ marginTop: "0.25rem", display: "inline-block" }}>Admin Portal</span>
        </div>
        ...
        <div style={{ marginBottom: "1.5rem", paddingBottom: "1.5rem", borderBottom: "1px solid var(--c-surface-border)" }}>
          ...
          <strong style={{ display: "block", color: "var(--c-text-main)" }}>{user?.name || "Administrator"}</strong>
        ...
        <nav style={{ display: "flex", flexDirection: "column", gap: "0.5rem", flexGrow: 1 }}>
          ...
          <Link href="/admin/users" className={`btn ${pathname.startsWith("/admin/users") ? "btn-primary" : "btn-outline"}`} style={{ justifyContent: "flex-start" }}>
            Manage Users
          </Link>
          <Link href="/admin/subjects" className={`btn ${pathname.startsWith("/admin/subjects") ? "btn-primary" : "btn-outline"}`} style={{ justifyContent: "flex-start" }}>
            Manage Subjects
          </Link>
          <Link href="/admin/reports" className={`btn ${pathname.startsWith("/admin/reports") ? "btn-primary" : "btn-outline"}`} style={{ justifyContent: "flex-start" }}>
            System Reports
          </Link>
        </nav>
